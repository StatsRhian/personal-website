...
![](screenshot-github.png){width="80%" fig-align="center" fig-alt="Screenshot of the GitHub project board used to track QA for our model. Link in previous sentence."}
